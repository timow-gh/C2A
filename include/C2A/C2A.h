...
struct C2A_ContactResult {
  void FreePairsList();
  void SizeTo(int n);
  void Add(const C2A_ContactFeature &f1, const C2A_ContactFeature &f2,
           PQP_REAL distance, PQP_REAL p[], PQP_REAL q[]);
...
public:
  ...
  ContactF(int FeatureType_A, int FeatureType_B, int FeatureID_A[3],
           int FeatureID_B[3], int TriangleID_A, int TriangleID_B,
           PQP_REAL P_A[3], PQP_REAL P_B[3], PQP_REAL Distance);
...
int C2A_Distance_At_ContactSpace(C2A_DistanceResult *result, PQP_REAL R1[3][3],
...
int C2A_Collide(PQP_CollideResult *result, PQP_REAL R1[3][3], PQP_REAL T1[3],
                C2A_Model *o1, PQP_REAL R2[3][3], PQP_REAL T2[3], C2A_Model *o2,
                int flag = C2A_ALL_CONTACTS);

int C2A_Distance(C2A_DistanceResult *result, PQP_REAL R1[3][3], PQP_REAL T1[3],
                 C2A_Model *o1, PQP_REAL R2[3][3], PQP_REAL T2[3],
                 C2A_Model *o2, PQP_REAL rel_err, PQP_REAL abs_err,
                 int qsize = 2);

int C2A_Collide(C2A_DistanceResult *result, PQP_REAL R1[3][3], PQP_REAL T1[3],
                C2A_Model *o1, PQP_REAL R2[3][3], PQP_REAL T2[3], C2A_Model *o2,
...
PQP_REAL C2A_QueryTimeOfContact(CInterpMotion *objmotion1,
                                ...
                                PQP_REAL tolerance_t, int qsize = 2);

PQP_REAL C2A_QueryContact(CInterpMotion *objmotion1, CInterpMotion *objmotion2,
                          C2A_TimeOfContactResult *res, C2A_Model *o1,
                          C2A_Model *o2, double threshold);
